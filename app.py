...
st.set_page_config(
    page_title="Multi-Object Tracking (MOT) Suite",
    page_icon="🎥",
    layout="wide"
)
...
# Render UI
st.title("🎥 Multi-Object Tracking (MOT) Suite")
st.markdown("Analyze live video streams or local files with high-speed multi-object tracking (**YOLOv8 + ByteTrack**) on CPU.")

# Sidebar Configuration
st.sidebar.header("⚙️ Tracker Configuration")
...
sample_interval = st.sidebar.slider("Sampling Interval (seconds)", min_value=0.01, max_value=5.0, value=0.1, step=0.05, help="Controls tracking frequency. Set lower for smoother real-time trails.")
...
with tab1:
    ...
    with col2:
        st.write("📋 **Real-time Tracking Log**")
